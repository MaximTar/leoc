    ...
    def update_data(self, orb):
        ...
        try:
            if self.settings:
                ...
                self.azimuth_lbl.setText("{:.3f}".format(az))
                self.elevation_lbl.setText("{:.3f}".format(el))
        except Exception:
        ...
        self.eccentricity_lbl.setText("{:.3f}".format(orb.orbit_elements.excentricity))
        self.inclination_lbl.setText("{:.3f}".format(orb.orbit_elements.inclination))
        self.arg_perigee_lbl.setText("{:.3f}".format(orb.orbit_elements.arg_perigee))
        self.mean_anomaly_lbl.setText("{:.3f}".format(orb.orbit_elements.mean_anomaly))
        self.semi_major_axis_lbl.setText("{:.3f}".format(orb.orbit_elements.semi_major_axis))
        self.period_lbl.setText("{:.3f}".format(orb.orbit_elements.period))
        self.perigee_lbl.setText("{:.3f}".format(orb.orbit_elements.perigee))
        ...
        self.b_star_lbl.setText("{:.3f}".format(orb.tle.bstar))
        self.ephemeris_type_lbl.setText("{:.3f}".format(orb.tle.ephemeris_type))
        self.element_number_lbl.setText("{:.3f}".format(orb.tle.element_number))
        self.orbit_lbl.setText("{:.3f}".format(orb.tle.orbit))
        self.right_ascension_lbl.setText("{:.3f}".format(orb.orbit_elements.right_ascension))
        self.mean_motion_lbl.setText("{:.3f}".format(orb.orbit_elements.mean_motion))
        self.epoch_year_lbl.setText(str(orb.tle.epoch_year))
        self.epoch_day_lbl.setText("{:.3f}".format(orb.tle.epoch_day))

        # self.right_ascension_lon_lbl.setText("{:.3f}".format(orb.orbit_elements.right_ascension_lon)
        # self.mean_motion_derivative_lbl.setText("{:.3f}".format(orb.tle.mean_motion_derivative)
        # self.mean_motion_sec_derivative_lbl.setText("{:.3f}".format(orb.tle.mean_motion_sec_derivative)
